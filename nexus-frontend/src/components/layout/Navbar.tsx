...
export const Navbar: React.FC<NavbarProps> = ({ onMenuToggle, unreadCount = 0 }) => {
  ...
  return (
    <nav className="bg-white shadow-md z-50">
      ...
      {/* Mobile top-level menu (limited set) */}
      {isMenuOpen && (
        <div className="md:hidden bg-white border-b border-gray-200 animate-fade-in absolute w-full shadow-lg">
